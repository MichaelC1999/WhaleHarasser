...
export function NetworkSwitcher() {
    ...
    if (isEthereumAvailable) {
        if (windowOverride?.ethereum?.networkVersion == "134") {
            // This component renders on all pages. If the network is RLC, render nothing
            return null;
        }
    } else {
                ...
                <DialogContent>
                    <Box display="flex" flexDirection="column" alignItems="center" >
                        <Typography variant="body1">
                            This dApp is deployed on RLC (Chain ID 134)
                        </Typography>
                        <Typography variant="body1">
